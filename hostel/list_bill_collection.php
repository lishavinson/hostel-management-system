...
WHERE hostel_bill_calculator.hb_id=$hb_id and hd_status='paid'";
                ...
                <div class="row">
                    <div class="col-md-12">		
						<div class="card">
							...
							<strong class="card-title">Collected Bills Report @ <span class="text-primary"><?php echo $hb_month; ?></span></strong>

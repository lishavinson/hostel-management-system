...
WHERE hostel_bill_calculator.hb_id=$hb_id and hd_status='not paid'";
                ...
                <div class="row">
                    <div class="col-md-12">		
						<div class="card">
							...
							<strong class="card-title">Pending Bills Report @ <span class="text-primary"><?php echo $hb_month; ?></span></strong>
							<a href="list_bill_1.php" class="btn btn-sm btn-outline-primary pull-right"><i class="fa fa-angle-left"></i>&nbsp; Back</a>
							</div>
							<div class="card-body">

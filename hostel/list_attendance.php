										...
										<tr>
											<td class="d-flex align-items-center justify-content-between">
												...
												<ul class="list-group w-75 ml-5">
												  ...
												  <a href="sqlprocess/updateattendance_sql_process.php?at_date=<?php echo $at_date; ?>&mode=<?php echo $mode;?>&at_id=<?php echo $row["at_id"];?>&ha_id=<?php echo $row["ha_id"];?>" class="btn <?php echo $at_link_color; ?> btn-sm"><i class="fa fa-check"></i>&nbsp; <?php echo $at_link_text; ?></a>
												  </span>
												  </li>
												</ul>
											</td>
